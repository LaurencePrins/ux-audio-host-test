...
/* Exported constants --------------------------------------------------------*/
#define USBX_HOST_MEMORY_STACK_SIZE     20*1024

#define UX_HOST_APP_THREAD_STACK_SIZE   1024
#define UX_HOST_APP_THREAD_PRIO         10

/* USER CODE BEGIN EC */
#define USB_HOST_EVENT_FLAG_CONNECTED     (1U)
#define USB_HOST_EVENT_FLAG_DISCONNECTED  (2U)

extern TX_EVENT_FLAGS_GROUP usb_host_events;
/* USER CODE END EC */
