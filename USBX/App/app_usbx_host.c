...
/* USER CODE BEGIN PV */
TX_EVENT_FLAGS_GROUP usb_host_events;
/* USER CODE END PV */
...
UINT MX_USBX_Host_Init(VOID *memory_ptr)
{
  ...
  /** Initialise events flags */
  if (ux_utility_event_flags_create(&usb_host_events, "usb_host_events") != UX_SUCCESS) 
  {
    return UX_ERROR;
  }

  /** Initialise audio host thread */
  if (usb_audio_host_init(memory_ptr) != UX_SUCCESS) 
  {
    return UX_ERROR;
  }
